        ...
        <section class="section">
            <div class="row">
                <div class="col-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form" action="{{ route('pedoman-pelayanan.store') }}" enctype="multipart/form-data" method="post">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="numb-doc-column" class="form-control" placeholder="Nomor" name="kd">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group col-12">
                                            ...
                                            <input type="file" id="file-doc" class="form-control" name="file_doc">
                                        </div>
                                    </div>
...
<script>
    ...
    const onAddItems = () => {
        ...
        <div class="row" id="items-${total}">
            ...
            <div class="col-md-4 col-12">
                <div class="form-group col-12">
                    <input type="file" id="file-doc" class="form-control" name="file_doc[${total}]">
                </div>
            </div>
            <div class="col-md-1 col-12">
                <a class="btn btn-transtaparant" onclick="onAddItems()"><i class="bi bi-plus-square"></i></a>
